...
2. Add a transient comparison workspace for review sessions without storing source-specific match scores, category explanations, or ranking reasons as long-term cached facts.
